...
var MAPA =
         ...
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPPPPPPPPPPMPPPPRRPRPRPPPPPPMPPPPPPPPMMM" +
         "MMMPRRRPRPRPPAPPRPPPPRPRPRRRPPBPPPPPPFPMMM" +
         "MMMPPPPPRPRPPMPPRPRRPPPPPRPPPPMPPPPPPPPMMM" +
         "MMMPRRMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPRPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPRPPRPPPPPPMPPPPPRPRPPPPMPPPPPRPPRPPMMM" +
         "MMMPRPPRPRRRPP9PPRPPRPRRRPP8PPRPPRPPRRPMMM" +
         "MMMPPPPPPPPRPPMPPRPPPPPPRPPMPPRPPPPPPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPRPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM7MMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPPPMMM" +
         "MMMPPPPRPMPPRPPPPPRPPPPPRPPPPMPPPPRRPRPMMM" +
         "MMMPPPPRP5PRRPPRPPRPRRPPRPRRP6PPRPPRPRPMMM" +
         "MMMRRPPPPMPPPPPRPPPPPRPPPPPPPMPPRPPPPPPMMM" +
         "MMMPPPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMRRPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPPPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPRPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPRPPPPMPPPPPRPPPPPPPRPPMPPPRPPRPPPPPMMM" +
         "MMMPRRPRP4PPRRPRRRPRRRPRRP3PRPRRPRPRPPPMMM" +
         "MMMPPPPRPMPPPPPPPRPRPPPPPPMPPPPPPPPRRRPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMRRPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMRRPMMM" +
         "MMMPPPPRPPPPRPPPPMPPPPPPPRRRPPPRPMPRPRPMMM" +
         "MMMRRRPRPRPPRPRRP1PPRPRRPRPPPPPRP2PRPRPMMM" +
         "MMMPPPPPPRPPPPPPPMPPRPPRPRPPRRPPPMPPPPPMMM" +
         "MMMPRRMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPPPMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPRRMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMPPRPPPPPPRPPPRPPRPMPPPPPPRPPPPPPPPPPMMM" +
         "MMMPPRRRPRPPRPPRRRPRP0PRPRRPRPRPPRPPPIPMMM" +
         "MMMPPPPPPRPPPPPPPPPRPMPRPPPPPPPPPRPPPPPMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM" +
         "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM";
...
function valorDificuldade(posicao_x, posicao_y) {
...
function desenharNaTela() {
    ...
    html_da_tabela = "<table  border=\"0\" cellspacing=\"0\" cellpadding=\"0\"style=\"border-collapse:collapse; border-spacing:0px; vertical-align: top;\">";

    for (linha = 0; linha < LINHAS; linha++) {
        html_da_tabela += "<tr style=\"box-sizing:content-box\">";

        for (coluna = 0; coluna < COLUNAS; coluna++) {
            if (matrix_do_mapa[linha][coluna] == "M")
                html_da_tabela += "<td ><img src='\M.png' height=\'25px\' width=\'25px\' ></td>";
            else if (matrix_do_mapa[linha][coluna] == "P")
                html_da_tabela += "<td ><img src='\P.png' height=\'25px\' width=\'25px\'></td>";
            else if (matrix_do_mapa[linha][coluna] == "R")
                html_da_tabela += "<td><img src='\R.png'height=\'25px\' width=\'25px\'></td>";
            else if (matrix_do_mapa[linha][coluna] == "F")
                html_da_tabela += "<td><img src='\F.png'height=\'25px\' width=\'25px\'></td>";
            else if (matrix_do_mapa[linha][coluna] == "I")
                html_da_tabela += "<td><img src='\I.png'height=\'25px\' width=\'25px\'></td>";
                ...
                html_da_tabela += "<td><img src='\C.png' style=\"margin-left:2px\"></td>";
            else
...
function atualizarMapaNaTela() {
    ...
    document.getElementById("cavaleiros").innerHTML = " <div class=\"card\" ><div class=\"card-body\"><h1 class=\"card-title\"></h1>"+
    "<div>"+
       " <img src=\'Seiya.jpg' style=\'height:100px; width:100px;\'><br>Seiya <br> Vida Restante[" + folhas_da_arvore[0].vida_dos_cavaleiros[0] + "]"+
        
    "</div>"+
  "</div></div>"+

  "<div class=\"card\" ><div class=\"card-body\"><h1 class=\"card-title\"></h1>"+
    "<div>"+
       " <img src=\'Shiryu.jpg' style=\'height:100px; width:100px;\'><br>Shiryu <br> Vida Restante[" + folhas_da_arvore[0].vida_dos_cavaleiros[1] + "]"+
  ...
  "<div class=\"card\" ><div class=\"card-body\"><h1 class=\"card-title\"></h1>"+
    "<div>"+
    " <img src=\'Hyoga.jpg' style=\'height:100px; width:100px;\'><br>Hyoga <br> Vida Restante[" + folhas_da_arvore[0].vida_dos_cavaleiros[2] + "]"+
  ...
  "<div class=\"card\" ><div class=\"card-body\"><h1 class=\"card-title\"></h1>"+
    "<div>"+
    " <img src=\'Shun.jpg' style=\'height:100px; width:100px;\'><br>Shun <br> Vida Restante[" + folhas_da_arvore[0].vida_dos_cavaleiros[3] + "]"+
  ...
  "<div class=\"card\" ><div class=\"card-body\"><h1 class=\"card-title\"></h1>"+
    "<div>"+
    " <img src=\'Ikki.jpg' style=\'height:100px; width:100px;\'><br>Ikki <br> Vida Restante[" + folhas_da_arvore[0].vida_dos_cavaleiros[4] + "]"+
        
    "</div>"+
  "</div></div>";
    
    document.getElementById("tempo").innerHTML = "<br>" + (folhas_da_arvore[0].tempo_caminhando).toFixed(2);
    document.getElementById("somatorio").innerHTML = "<br>" + ((folhas_da_arvore[0].tempo_caminhando + matrix_do_peso_das_distancias[folhas_da_arvore[0].posicao_x_da_folha][folhas_da_arvore[0].posicao_y_da_folha])).toFixed(2);
    document.getElementById("distancia").innerHTML = "<br>" + (matrix_do_peso_das_distancias[folhas_da_arvore[0].posicao_x_da_folha][folhas_da_arvore[0].posicao_y_da_folha]).toFixed(2);
...
function todasLutasPossiveisDosCavaleiros(cavaleiros_que_vao_brigar, deslocamento_x, deslocamento_y, movimento_feito) {
    ...
    folhas_da_arvore[folhas_da_arvore.length - 1].tempo_caminhando += valorDificuldade(folhas_da_arvore[folhas_da_arvore.length - 1].posicao_x_da_folha, folhas_da_arvore[folhas_da_arvore.length - 1].posicao_y_da_folha) / somatorioDosCavaleiros(cavaleiros_que_vao_brigar);
